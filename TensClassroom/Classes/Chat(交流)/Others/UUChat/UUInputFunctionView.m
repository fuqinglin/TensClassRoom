...
- (id)initWithSuperVC:(UIViewController *)superVC
{
    ...
    if (self) {
        ...
        [self.btnSendMessage addTarget:self action:@selector(showImagePicker:) forControlEvents:UIControlEventTouchUpInside];
        ...
        self.TextViewInput.showsVerticalScrollIndicator = NO;
...
{
    [self.delegate UUInputFunctionView:self sendVoice:voicePath time:playTime+1];
